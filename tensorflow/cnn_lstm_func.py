...
p_path = 'E:\\pg\\1-SKA\\Data\\MedlatTrainingData\\pulsars_attrs_aug.pkl'
n_path = 'E:\\pg\\1-SKA\\Data\\MedlatTrainingData\\RFI_attrs_aug.pkl'
...
def LSTM_model():
    ...
    lstm_W_fc1 = weight_variable([CELLSIZE*t_len,1024])
...
def main():
    ...
    for i in range(2000):
        ...
        feed_dict = {X_subbands:cnn_input,X_subints:lstm_input,Hin:istate,y_:batch[4],cnn_other_attr:other_attrs, cnn_keep_prob:0.5}
